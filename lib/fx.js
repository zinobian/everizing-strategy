...
async function getUsdKrwRate() {
  ...
  try {
    ...
    const raw = await inquireUsdKrw(accessToken, appKey, appSecret);
    ...
    // output1: 현재 요약, output2: 일별
    const o1 = raw.output1 || {};
    const rate = parseFloat(o1.ovrs_nmix_prpr || o1.last || 0);
    const prev = parseFloat(o1.ovrs_nmix_prdy_clpr || o1.base || 0);
