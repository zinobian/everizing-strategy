...
const CONFIG = {
  ...
  tickers: {
    ...
    SOXL: { name: '반도체 3배',   dailyBuy: 30000, leverage: 3, excd: 'NAS' },
    GDXU: { name: '금광 3배',     dailyBuy: 30000, leverage: 3, excd: 'AMS' },
    AGQ:  { name: '은 2배',       dailyBuy: 30000, leverage: 2, excd: 'AMS' },
    DFEN: { name: '방산 3배',     dailyBuy: 10000, leverage: 3, excd: 'AMS' },
